...
export async function GET(req: NextRequest) {
    ...
    try {
        ...
        (select count(uploadSeq) from tb_data_newcontracts where a.upchaSeq = upchaSeq and useYn = 'Y'), '건 / 만기: ', 
        (select count(uploadSeq) from tb_data_expirecontracts where a.upchaSeq = upchaSeq and useYn = 'Y'), '건') 
